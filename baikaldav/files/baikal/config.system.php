...
define("BAIKAL_AUTH_REALM", '{{iconfig.auth_realm}}');
...
define("PROJECT_DB_MYSQL_HOST", '{{iconfig.dbhost}}');

# MySQL > Database name
define("PROJECT_DB_MYSQL_DBNAME", '{{iconfig.dbname}}');

# MySQL > Username
define("PROJECT_DB_MYSQL_USERNAME", '{{iconfig.dbuser}}');

# MySQL > Password
define("PROJECT_DB_MYSQL_PASSWORD", '{{iconfig.dbpass}}');

# A random 32 bytes key that will be used to encrypt data
define("BAIKAL_ENCRYPTION_KEY", '{{iconfig.baikal_encryption_key}}');

# The currently configured Baïkal version
define("BAIKAL_CONFIGURED_VERSION", '{{iconfig.version}}');